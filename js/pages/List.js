    ...
    <main v-else class="page-list">
      ...
      <div class="meta-container">
                <div class="meta">
                    ...
                    <p>
                        Any levels placed #51 and below are on the legacy list. We will accept records on levels for 24 hours after they fall off the top #50. After this time is up, submissions for said levels will be closed and not accepted further. HOWEVER, any submission of a level in the legacy list may be accepted if there is valid proof of the level being completed before the date of it falling off the top 50 (any legacy list level submission with a completion date before August 21st, 2026 is acceptable.)
                    </p>
                    <p>
